...
export default function Otp() {
  ...
  // Stubbed: any complete 6-digit code passes. Real verification comes later.
  const verify = () => {
    ...
    <Screen contentStyle={styles.screen}>
      ...
      <View style={styles.resend}>
        {seconds > 0 ? (
          ...
          <Text variant="cardRole">
            ¿No llegó?{' '}
            <Text variant="cardRole" color={colors.accent} onPress={startResend}>
              Reenviar código
            </Text>
          </Text>
        )}
      ...
      <Button label="VERIFICAR" fullWidth onPress={verify} />
    </Screen>
  );
}
